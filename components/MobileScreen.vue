<template>
  <transition>
    ...
    >
      <svg
        id="Capa_1"
        :class="changeBackgroundClass"
        class="reload fill-current relative w-6 h-6"
        version="1.1"
...
export default {
  ...
  computed: {
    ...
    changeBackgroundClass() {
      return [
        this.background.disabled ? 'text-gray-500' : 'text-white',
        this.background.disabled ? 'cursor-auto' : 'cursor-pointer'
      ]
    }
  },
